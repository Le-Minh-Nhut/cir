    ...
    *,
    ...
    for epoch in range(num_epochs):
        ...
        print(
            ...
            f" | func_initial_slots="
            f"{train_metrics.get('functional/credited_slots', float('nan')):.2f}"
            f" | func_initial_residual="
            f"{train_metrics.get('functional/residual_active_modes', float('nan')):.2f}"
            f" | func_initial_coverage="
            f"{train_metrics.get('functional/initial_unique_mode_coverage', float('nan')):.3f}"
            f" | func_initial_redundant="
            f"{train_metrics.get('functional/initial_redundant_credit_fraction', float('nan')):.3f}"
            f" | func_pair="
            ...
            f" | func_initial_owned="
            f"{train_metrics.get('functional/initial_owned_mode_count', float('nan')):.2f}"
            f" | func_initial_unowned="
            f"{train_metrics.get('functional/initial_unowned_positive_mode_count', float('nan')):.2f}"
            f" | func_giant="
            ...
            " | cond_steps="
            f"{train_metrics.get('functional/conditional_steps', float('nan')):.2f}"
            " cond_slots="
            f"{train_metrics.get('functional/conditional_credited_slots', float('nan')):.2f}"
            " cond_modes="
            f"{train_metrics.get('functional/conditional_credited_modes', float('nan')):.2f}"
            " cond_gain="
            f"{train_metrics.get('functional/conditional_residual_gain', float('nan')):.3f}"
            " cond_stop="
            f"{train_metrics.get('functional/conditional_stop_no_gain_fraction', float('nan')):.3f}"
            " cond_clone_reject="
            f"{train_metrics.get('functional/conditional_clone_rejection_fraction', float('nan')):.3f}"
            " cond_pair="
            f"{train_metrics.get('functional/conditional_pair_fraction', float('nan')):.3f}"
            " cond_claimed="
            f"{train_metrics.get('functional/conditional_claimed_modes', float('nan')):.2f}"
            " cond_ever="
            f"{train_metrics.get('functional/conditional_ever_achievable_modes', float('nan')):.2f}"
            " cond_unresolved="
            f"{train_metrics.get('functional/conditional_unresolved_modes', float('nan')):.2f}"
        )
