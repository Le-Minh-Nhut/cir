    ...
    *,
    ...
    for epoch in range(num_epochs):
        ...
        print(
            ...
            f" | routing_non_qasa_active="
            f"{train_metrics.get('diagnostic/routing_non_qasa_active_slot_count', float('nan')):.2f}"
            f" | routing_non_qasa_mass="
            f"{train_metrics.get('diagnostic/routing_non_qasa_mass_mean', float('nan')):.3f}"
            f" | routing_non_qasa_fraction="
            f"{train_metrics.get('diagnostic/routing_non_qasa_mass_fraction', float('nan')):.3f}"
            f" | execution_non_qasa_active="
            f"{train_metrics.get('diagnostic/execution_non_qasa_active_slot_count', float('nan')):.2f}"
